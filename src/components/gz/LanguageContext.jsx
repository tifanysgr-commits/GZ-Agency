  ...
  es: {
    ...
    pricing: {
      ...
      points: [
        ...
        'Haz que todos entiendan por que tu producto es increible.',
      ],
      strategyCta: 'Reservar una sesion de estrategia',
      testimonial: 'Que video! Que historia! Fue una gran experiencia para mi. El resultado final me puso la piel de gallina. Es nuestro mejor material de ventas.',
      testimonialName: 'Gary Borg',
      testimonialRole: 'Founder, Chatterborg',
      formTitle: 'Recibe una propuesta en 6 horas',
      labels: {
        name: 'Tu nombre',
        ...
        source: 'Como nos encontraste?',
      },
      placeholders: {
        name: 'Annie January',
        company: 'Vaught Corporations',
        email: 'starlight@vaught.com',
        contact: '+34 612 34 56 78',
        brief: 'Necesito un video de marca para representar los valores de la empresa a una audiencia concreta.',
      },
      options: {
        need: ['Video explicativo', 'Demo de producto', 'Video de evento', 'Resumen de producto', 'Video de marca', 'Video walkthrough', 'Video corporativo', 'Ads para redes sociales', 'Algo distinto', 'No estoy seguro'],
        budget: ['€150 - €250', '€250 - €350', '€350 - €450', '€450 - €500'],
        source: ['LinkedIn', 'YouTube', 'Cold Email'],
      },
      submitCta: 'Obtener propuesta',
    },
    services: {
    ...
    booking: {
      ...
      timezone: 'Madrid (GMT+01)',
      description: 'Reunión 1:1 de 30 minutos para entender tu negocio, tu audiencia y los objetivos de crecimiento.',
      openExternal: 'Abrir reserva en nueva pestaña',
      popupTitle: 'Reserve su conversación',
      popupDescription: 'Para continuar con su reserva en Google Calendar y Google Meet, pulse el botón y se abrirá una ventana emergente segura.',
      popupCta: 'Programar una conversación',
    },
  },
  en: {
    topbar: {
    ...
    pricing: {
      ...
      points: [
        ...
        'Tell people how awesome your product is.',
      ],
      strategyCta: 'Book a Strategy Session',
      testimonial: 'What a video! What a story! It was a great experience for me. The final video gave me goosebumps. It is our best sales material.',
      testimonialName: 'Gary Borg',
      testimonialRole: 'Founder, Chatterborg',
      formTitle: 'Get a quote within 6 hours',
      labels: {
        name: 'Your Name',
      ...
      placeholders: {
        ...
        email: 'starlight@vaught.com',
        contact: '+34 612 34 56 78',
        brief: 'I need a brand video to represent Vaught\'s values to a specific set of audience.',
      },
      options: {
        need: ['Explainer Video', 'Product Demo', 'Event Video', 'Product Overview', 'Brand Video', 'Walkthrough Video', 'Corporate Video', 'Social Media Ads', 'Something Else', 'Not Sure'],
        budget: ['€150 - €250', '€250 - €350', '€350 - €450', '€450 - €500'],
        source: ['LinkedIn', 'YouTube', 'Cold Email'],
      },
      submitCta: 'Get Quote',
    ...
    booking: {
      ...
      platform: 'Google Meet',
      timezone: 'Madrid (GMT+01)',
      description: 'Join a 1:1 session for 30 minutes where we get to know your business, audience, and goals.',
      openExternal: 'Open booking in a new tab',
      popupTitle: 'Schedule your conversation',
      popupDescription: 'To continue in Google Calendar and Google Meet, please use the button below to open a secure booking pop-up.',
      popupCta: 'Schedule a conversation',
    },
  },
};
